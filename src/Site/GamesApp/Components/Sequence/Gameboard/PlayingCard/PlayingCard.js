...
/* JSX */
    ...
    cardJSX = (
        <Card sx={{ height: '4.9vmax', width: '3.5vmax', maxHeight: '6vh', maxWidth: '4.29vh', backgroundColor: '#FAF9F6', color: color, border: '0.1px solid black', borderRadius: '0.25em', margin: 0.5, marginBottom: handCardState === 'raised' ? 2 : 0, cursor: 'pointer' }} onClick={props.onClick} >
